                ...
                <div class="col-lg-6">
                  <div class="p-5">
                    ...
                    <!-- <form class="user" action='' method='post'>
                      <div class="form-group">
                        <input type='text' name='user_id' class="form-control form-control-user" id="user_id" aria-describedby="emailHelp" placeholder="Enter user id...">
                      </div>
                  ...
                  if (isset($_POST['login_with_otp'])) {
                    ...
                    if ($_SESSION['otp'] == $otp) {
                      ...
                      //session_start();
                     echo  $query = "SELECT * FROM `users` WHERE email='" . $_GET['id'] . "'";
                      //echo $query;
                      $result = mysqli_query($link, $query);
                      // $fetch_user_id='';
                      // $row = mysqli_fetch_assoc($result);
