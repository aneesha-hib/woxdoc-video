...
$query = "SELECT  * FROM medicine where medicine_id = '".$_GET['medicine_id']."'"; 
//echo $query ;
              ...
              <form class="user" method="POST" >
                <div class="form-group ">
                  <!-- <div class="col-sm-6 mb-3 mb-sm-0"> -->
                    <input type="text" class="form-control form-control-user" id="medicine_name" name="medicine_name" placeholder="Medicine Name" value="<?php  echo $medicine_name?>" required>
                  <!-- </div> -->
                </div>
                <div class="form-group">
                  <!-- <div class="col-sm-6"> -->
                    <input type="text" class="form-control form-control-user" id="medicine_usage" name="medicine_usage" placeholder="Medicine Usage" value="<?php  echo $medicine_usage?>" required>
                  <!-- </div> -->
                </div>
