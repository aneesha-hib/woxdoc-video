...
?>		
                    ...
                    <tr>
					  ...
					  <td><?php echo $sex; ?></td>
                      <td><?php echo $Age; ?></td>
                      <td><?php echo $doctor_id; ?> 
                      <button class="btn btn-primary btn-sm text-light  view_doctor" id=<?php echo $doctor_id ?>><i class="fa fa-pencil" aria-hidden="true">View Doctor</i></button>
                      </td>
					  <!-- <td>
