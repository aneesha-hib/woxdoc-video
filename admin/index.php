...
$query = "SELECT count(*) as count FROM `patient_list` "; 
//echo $query;
$result = mysqli_query($link,$query);
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">No of patients</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $count ?></div>
                    </div>
                    <div class="col-auto">
...
<?php		
require_once '../config.php';
$query = "SELECT count(*) as count FROM `patient_list` WHERE created_on > (NOW() - INTERVAL 1 MONTH) "; 
$result = mysqli_query($link,$query);
            ...
            <div class="col-xl-4 col-md-6 mb-4">
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Patients Joined this month</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $count; ?></div>
                    </div>
                    <div class="col-auto">
